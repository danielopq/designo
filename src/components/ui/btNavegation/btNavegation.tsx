 ...
 */
const BtNavegation: React.FC<BtNavegationProps> = ({ text, btStyle }) => {
    return (
        <button className='btNavegation' style={{ color: (btStyle == 'dark') ? 'var(--darkGrey)' : 'white' }}>{text.toUpperCase()}</button>
    )
}
